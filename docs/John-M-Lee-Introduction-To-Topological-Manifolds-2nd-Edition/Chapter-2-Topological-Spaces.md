...
**Solution**
First let's prove that \(\overline{A} = A \cup \partial A\), which will be accomplished by showing that \(\overline{A} \subseteq A \cup \partial A\) and \(A \cup \partial A \subseteq \overline{A}\). We shall begin by showing that \(\overline{A} \subseteq A \cup \partial A\).
